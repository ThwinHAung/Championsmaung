...
class BodyBetPendingMatches extends StatefulWidget {
  static const String id = "body_bet_pending_matches";

  // constructor for custom radio button widget

  const BodyBetPendingMatches({super.key});

  @override
  State<BodyBetPendingMatches> createState() => _BodyBetPendingMatchesState();
}

class _BodyBetPendingMatchesState extends State<BodyBetPendingMatches> {
