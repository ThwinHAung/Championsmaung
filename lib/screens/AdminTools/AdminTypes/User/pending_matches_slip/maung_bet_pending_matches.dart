...
class MaungBetPendingMatches extends StatefulWidget {
  static const String id = "maung_bet_pending_matches";

  // constructor for custom radio button widget

  const MaungBetPendingMatches({super.key});

  @override
  State<MaungBetPendingMatches> createState() => _MaungBetPendingMatchesState();
}

class _MaungBetPendingMatchesState extends State<MaungBetPendingMatches> {
