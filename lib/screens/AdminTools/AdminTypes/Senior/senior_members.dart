...
class SeniorMembers extends StatefulWidget {
  static String id = 'senior_member_page';
  const SeniorMembers({super.key});

  @override
  State<SeniorMembers> createState() => _SeniorMembersState();
}

class _SeniorMembersState extends State<SeniorMembers> {
