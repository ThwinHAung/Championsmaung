...
class SeniorAdminScreen extends StatefulWidget {
  static String id = 'senior_admin_screen';
  const SeniorAdminScreen({super.key});

  @override
  State<SeniorAdminScreen> createState() => _SeniorAdminScreenState();
}

class _SeniorAdminScreenState extends State<SeniorAdminScreen> {
  var list = [
    'Members',
    'Balance',
    'Downtime Balance',
