...
class _SSeniorShowMembersListState extends State<SSeniorShowMembersList> {
  ...
  Future<void> _fetchMemberList() async {
    var url = Uri.parse('https://www.championmaung.com/api/getmemberlist');
  ...
  Future<void> _reduceUnits(String userId) async {
    var url = Uri.parse('https://www.championmaung.com/api/reducing_units');
  ...
  Future<void> _addUnits(String userId) async {
    var url = Uri.parse('https://www.championmaung.com/api/adding_units');
    final response = await http.post(url, headers: {
      'Authorization': 'Bearer $_token',
    }, body: {
      "user_id": userId,
  ...
  Future<void> _setPP(String userId) async {
    var url = Uri.parse('https://www.championmaung.com/api/postpone_user');
    final response = await http.post(url, headers: {
      'Authorization': 'Bearer $_token',
    }, body: {
      "user_id": userId,
  ...
  Future<void> _unsetPP(String userId) async {
    var url = Uri.parse('https://www.championmaung.com/api/unpostpone_user');
    final response = await http.post(url, headers: {
      'Authorization': 'Bearer $_token',
    }, body: {
      "user_id": userId,
  ...
  Future<void> _delete(String userId) async {
    var url = Uri.parse('https://www.championmaung.com/api/delete_user');
    final response = await http.post(url, headers: {
      'Authorization': 'Bearer $_token',
    }, body: {
      "user_id": userId,
