...
class SSSeniorMasterReport extends StatefulWidget {
  static String id = 'sssenior_master_report';

  const SSSeniorMasterReport({
    super.key,
  });

  @override
  State<SSSeniorMasterReport> createState() => _SSSeniorMasterReportState();
}
