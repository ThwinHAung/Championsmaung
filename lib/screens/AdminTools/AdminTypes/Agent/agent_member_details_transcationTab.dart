...
class AgentTransactionsTab extends StatefulWidget {
  final int userId;

  const AgentTransactionsTab({Key? key, required this.userId})
      : super(key: key);

  @override
  State<AgentTransactionsTab> createState() => _AgentTransactionsTabState();
}

class _AgentTransactionsTabState extends State<AgentTransactionsTab> {
  DateTime? startDate;
  DateTime? endDate;
