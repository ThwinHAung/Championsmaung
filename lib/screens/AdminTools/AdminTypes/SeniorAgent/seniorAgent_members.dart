...
class SeniorAgentMembers extends StatefulWidget {
  static String id = 'seniorAgent_member_page';
  const SeniorAgentMembers({super.key});

  @override
  State<SeniorAgentMembers> createState() => _SeniorAgentMembersState();
}
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Container(
                      child: Text(
                        'Your account type : ' + 'Senior  Agent',
                        style: TextStyle(
                          color: kBlue,
